...
<!-- footer -->
 <form name="f" class="form" method="POST" action="supprimerUtilisateur.php">
	<div class="footer">
		<div class="container">
		...
		<div class="col-md-9 footer-top1">
		 <p align="center"><font size="5">RESERVATION EN LIGNE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <hr>
                    <p align="center"><font size="3">CIN :<input type="text" class="form-control" name="Ncin" id="Ncin" size="3"></font></p>
                   
                    <p align="left"><font size="3">Depart : <select size="1" class="form-control" name="depart" id="depart">
                    ...
                    Destination : <select size="1" name="destination" class="form-control" id="destination">
                    ...
                    <input type="submit" class="btn btn-primary" value="supprimer" name="B1"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
