...
$listejury=$juryCore->afficher_return2();
?>
    ...
    <form method="POST" action="supprimerjury.php">
    <td><input type="submit" name="supprimer" class="btn btn-danger" value="supprimer">
        <input type="hidden" name="id" value="<?php echo $donne['id'];?>"></td>
    </form>

    <form method="POST" action="modifierjury.php">
    <td><input type="submit" class="btn btn-danger"  name="modifier" value="modifier"></td>
    ...
    <form action="pdff2.php" method="post">
    <td>
