...
if (isset($_GET['search_key'])) {
        $list = $cc->recherclient($_GET['search_key'],$cc->conn);
    } else {
       $list=$cc->afficheClientdesactive($cc->conn);
    }
...
?> 
					  ...
					  <form method="get" action="affichageDesClientsactive.php">
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
                                 <th><i></i> ID</th>
                                 <th><i class="icon_calendar"></i>login </th>
	...
	<center><button  style="color:white;text-align:center;background-color:#00BCDF;border-color:transparent;"><a  style="color:white;" href="../cores/crudClient.php?id=1&id_client=<?php echo $l['id_client']; ?>" role="button"> Supprimer </a></button>
	</td>
	<td>
	...
	<a class="ace-icon fa fa-unlock bigger-110 icon-only"  href="desactiver.php?id_client=<?php echo $l['id_client']; ?>  "> </a>
										</a>	
<?php } else { ?>
																
	<a class="ace-icon fa glyphicon-lock bigger-110 icon-only" href="active.php?id_client=<?php echo $l['id_client']; ?>  "  >
															</a>
															<?php } ?>										
