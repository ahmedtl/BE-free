...
$aa=new Votes();
 ...
 $listechefs = $aa->affichechffgroupedbylike($aa->conn);

?>

                      <div class="panel-body">
                        <div class="panel panel-primary">
                          <div class="panel-heading">les listes des chefs par les utilisateur qui ont fait des likes</div>
                          <div class="panel-content">
                              <table class="table table-hover table-lg">
                                            <thead>
                                                <tr>
                                                    <td class="text-dark text-semibold">id_chef</td>
                                                    <td class="text-dark text-semibold">Nom_chef</td>
                                                    <td class="text-dark text-semibold">Prenom_chef</td>
                                                    <td class="text-dark text-semibold">Image</td>
                                                   <td class="text-dark text-semibold">user_id</td>
                                                    
                                                    <td class="text-dark text-semibold">nom_client</td>
                                                    <td class="text-dark text-semibold">prenom_client</td>
