...
foreach($listeSpecialites as $row)
{
    ...
    <td><form method="POST" action="supprimerSpecialite.php">
    <input type="submit" name="supprimer" value="supprimer"  class="btn btn-danger">
    <input type="hidden" value="<?PHP echo $row['codeS']; ?>" name="codeS">
    </form>
    </td>
    <td><a href="modifierSpecialite1.php?codeS=<?PHP echo $row['codeS']; ?>">
    Modifier</a></td>
    </tr>
    <?PHP
}
