...
$aa=new Votes();
 ...
 if (isset($_GET['search_key'])) {
        $listechefs = $cc->recherchechef($_GET['search_key'],$cc->conn);
    } else {
       $listechefs = $cc->affichechffsalaire($cc->conn);
    }
 ...
 <form method="get" action="afficherChef.php">
                      ...
                      <div class="panel-body">
                        <div class="panel panel-primary">
                          <div class="panel-heading">les listes des chefs</div>
                              ...
                              <table class="table table-hover table-lg">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td class="text-dark text-semibold">Age</td>
                                                    <td class="text-dark text-semibold">Domaine</td>
                                                    <td class="text-dark text-semibold">Salaire</td>
                                                    <td class="text-dark text-semibold">nouveaux Salaire</td>
                                                    <td class="text-dark text-semibold">Image</td>
                                                    <td class="text-dark text-semibold">nblike</td>
                                                    <td class="text-dark text-semibold">nbdislike</td>
                                                    <td class="text-dark text-semibold">action</td>
                                                    
                                                </tr>
                                            </thead>
                                            <?PHP
                                            foreach ($listechefs as $row) {
                                                $id_chef_chef=$row['id_chef'];
                                                
                                           $likes=$testt->getCountlike($id_chef_chef,$aa->conn);
                                           $dislikes=$testt->getCountdislikes($id_chef_chef,$aa->conn);
                                           $nv=($row['salaire_chef']+(10*$likes))-(5*$dislikes);
                                                ?>
                                                <tbody>
                                                    <tr>
                                                       <td>
                                                            <?PHP echo $row['id_chef']; ?>
                                                        </td>
                                                        <td>
                                                            <?PHP echo $row['nom_chef']; ?>
                                                        </td>
                                                        <td>
                                                            <?PHP echo $row['prenom_chef']; ?>
                                                        </td>
                                                        <td>
                                                            <?PHP echo $row['age_chef']; ?>
                                                        </td>
                                                        <td>
                                                            <?PHP echo $row['domaine_chef']; ?>
                                                        </td>
                                                        <td>
                                                            <?PHP echo $row['salaire_chef']; ?>
                                                        </td>
                                                        <td>
                                                            <?PHP echo $nv ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                           <img src="img/<?PHP echo $row['image']; ?>" style="width: 80px; alt="img"/> 
                                                        </td>
                                                        <td>
                                                            <?PHP echo $likes ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-warning btn-sm" title="Bootstrap 3 themes generator" href="modifierchef.php?id_chef=<?PHP echo $row['id_chef']; ?>"><i class="lni-pencil mr-2 text-muted"></i>Edit</a>
                                                                    <form method="POST" action="supprimerchef.php">
                                                                        <a class="dropdown-item"><i class="lni-trash ">
                                                             <input style="color:white;text-align:center;background-color:#00BCDF;border-color:transparent;" type="submit" name="supprimer" value="Remove"></i>
                                                                            <input type="hidden" value="<?PHP echo $row['id_chef']; ?>" name="id_chef">
                                                            </a></form>
