...
if (isset($_GET['codeS'])){
    ...
    $result=$specialiteC->recupererSpecialite($_GET['codeS']);
...
<caption>Modifier Specialite</caption>
<tr>
<td>Code Specialite</td>
<td><input type="number" name="codeS" value="<?PHP echo $codeS ?>"></td>
</tr>
<tr>
<td>Image Specialite</td>
...
<tr>
<td></td>
<td><input type="hidden" name="codeSS" value="<?PHP echo $_GET['codeS'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
    $specialite=new specialite($_POST['codeS'],$_POST['image'],$_POST['nomS'],$_POST['description']);
    $specialiteC->modifierSpecialite($specialite,$_POST['codeSS']);
