...
$listeformations=$formation1C->AfficherFormation() ;
?>
...
<div>
    <form method="POST" action="pdfachref.php">
        <input type="submit" name="create_pdf" value="Imprimer liste " class="btn btn-danger">
    </form>

</div>
<div>
    <form method="POST" action="top1.php">
        <input type="submit" name="example1" value="plus cher " class="btn btn-danger">
    </form>
    <form method="POST" action="soon.php">
        <input type="submit" name="example1" value="coming soon" class="btn btn-danger">
    </form>
