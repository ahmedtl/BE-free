...
<ul class="sidebar-menu">                
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <!-- houni -->
               <center><legend><h2>Tri Specialite</h2></legend></center>
 <?PHP
...
$specialite1C=new specialiteC();
 $listespe1=$specialite1C->afficherASC();
 $listespe2=$specialite1C->afficherDESC();
...
if (isset($_POST['asc'])) {
  ...
  <thead>
    <tr>
      ...
      <th >Iimage Specialite</th>
      <th >Nom Specialite</th>
      <th >Description</th>
    </tr>
  </thead>
<?php
foreach($listespe1 as $row)
{
    ?>
    <tr>
