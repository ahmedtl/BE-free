...
if (isset($_GET['id_chef']))
    ...
    $result=$chefC->recupererChef($_GET['id_chef'],$cc->conn);
    foreach($result as $row){
       /* $nom_chef=$row['nom_chef'];
        $prenom_chef=$row['prenom_chef'];
        $age_chef=$row['age_chef'];
        $domaine_chef=$row['domaine_chef'];
        $salaire_chef=$row['salaire_chef'];*/
...
<ul class="sidebar-menu">                
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Gestion Cheff</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                        <li><i class="icon_document_alt"></i>Cheff</li>
                        <li><i class="fa fa-file-text-o"></i>ajouter cheff</li>
                    </ol>
                </div>
            </div>
                              ...
                              <div class="form" >
                                  <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">nom chef <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="nom_chef" minlength="5" type="text"  value="<?PHP echo $row['nom_chef'] ?>" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">Prenom chef  <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cemail" type="text" name="prenom_chef"  value="<?PHP echo $row['prenom_chef'] ?>" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">age chef </label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="curl" type="number" name="age_chef"  value="<?PHP echo $row['age_chef'] ?>" required/>
                                          </div>
                                      </div>

                                      <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">domaine chef </label>
                                          <div class="col-lg-10">
                                              <select class="col-lg-10" name="domaine_chef" value="$row['domaine_chef']">
                                              <option>sucre</option>
                                              <option>sale </option>
                                      ...
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Salaire chef </label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="salaire_chef" minlength="5" type="number"  value="<?PHP echo $row['salaire_chef'] ?>" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Image chef </label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="image"  type="text"  value="<?PHP echo $row['image'] ?>"  />
                                          </div>
                                      </div>
                                   
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-primary" type="submit" name="modifier" value="modifier">modifier</button>
                                              <input type="hidden" name="id_chef" value="<?PHP echo $_GET['id_chef'];?>">
                                              <button class="btn btn-default" type="button" href="afficherChef.php">Cancel</button>
                                          </div>
                                      </div>
                                  </form>
...
if (isset($_POST['nom_chef']))
    $nom_chef=$_POST['nom_chef'];

if (isset($_POST['prenom_chef']))
    $prenom_chef=$_POST['prenom_chef'];


if (isset($_POST['age_chef']))
    $age_chef=$_POST['age_chef'];

if (isset($_POST['domaine_chef']))
    $domaine_chef=$_POST['domaine_chef'];

if (isset($_POST['salaire_chef']))
    $salaire_chef=$_POST['salaire_chef'];
...
$cc=new chefC();
    ...
    $cc->updateclient($id_chef,$nom_chef,$prenom_chef,$age_chef,$domaine_chef,$salaire_chef,$image,$cc->conn);
