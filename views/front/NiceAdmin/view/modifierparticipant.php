		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-file-text-o"></i>modifier</li>
					</ol>
				</div>
			</div>
        <?PHP
...
?>
   ...
   <form  method="GET" action="../view/modifparticipant.php" >
    <table border="1">
        <tr>
            <td>
                ...
                <table>
                    <tr>
                            ...
                            <td><input type="text" name="nv_id" value="<?PHP echo $_POST['id'] ?>"/></td>
                    </tr>
                    <tr>
                        <td><label>nom</label></td>
                        <td><input type="text" name="nv_nom" value="<?PHP echo $_POST['nom'] ?>" /></td>
                    </tr>

                    <tr>
                    <td>prenom</td>
                    <td><textarea name="nv_prenom" value="<?php echo $_POST['prenom'] ?>" /><?php echo $_POST['prenom'] ?></textarea></td>
                    </tr>

                
                    <tr>
                        <td><label>email</label></td>
                        <td><input type="text" name="nv_email" value="<?PHP echo $_POST['email'] ?>" /></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="nv_pays" value="<?PHP echo $_POST['pays'] ?>" /></td>
                    </tr>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input type="hidden" name="an_id" value="<?php echo $_POST['id'];?>">
