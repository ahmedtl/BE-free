...
<?php
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i>ajouter participant</h3>
                    <ol class="breadcrumb">
    ...
    <form  method="POST" action="ajouterparticipant.php" name="f1">
    <table border="1">
        <tr>
            <td>
...
<table>
   ...
   <tr>
    ...
    <tr>
        <td></td>
        <td><center><input type="submit" onclick="test()" value="ajouter" /></center></td>
