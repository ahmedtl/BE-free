...
if (isset($_GET['s']) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT codeS,image,nomS,description FROM specialite WHERE nomS LIKE ? OR codeS LIKE ?");
...
{
  $select_terme = $bdd->prepare("SELECT * FROM specialite ");
