...
$list=$reclamation1C->recupererReclamation();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<ul class="sidebar-menu">                
      ...
      <section id="main-content">
		  ...
		  <div class="row">
            ...
            <table id="myTable" class="display" style="width:100%" border="2">
        <thead>
            <tr>
                <th>Id</th>
                <th>nom</th>
        ...
        <?php
            ...
            <tr>
                ...
                <td>
                    <CENTER>
                   <?php if($row['etat'] == 0){ ?>
                    <form method="POST" action="validerReclamation.php/?id=<?php echo $row['id'] ?>">
                <button type="submit" class="btn btn-success" value="valider"> &nbsp &nbsp  Valider &nbsp &nbsp  </button>
                   </form>
                   <?php }else{ ?>
                <button type="" class="btn btn-success" value="valider" disabled> &nbsp &nbsp  Reclamation validée &nbsp &nbsp  </button>
                   <?php } ?>
               <form method="POST" action="supprimerReclamation.php/?id=<?php echo $row['id'] ?>">
