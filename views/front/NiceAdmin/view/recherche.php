...
try
{
 $bdd = new PDO("mysql:host=localhost;dbname=baseprojet", "root", "");
...
if (isset($_GET['s']) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT nom,description,imageUrl FROM Product WHERE nom LIKE ? OR description LIKE ?");
...
{
  $select_terme = $bdd->prepare("SELECT * FROM Product ");
...
<?php
    ...
    <ul class="sidebar-menu">                
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> Gestion </h3>
  ...
  <td><a><img class="" src="<?php echo $terme_trouve['imageUrl'];?>" style="width: 100px; height:100px;"></a></td>
