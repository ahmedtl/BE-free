...
<?php
  ...
  <head>
    ...
    <script language="javascript">
        function Afficher()
        {
            var codeF = document.f1.Id.value ;
            var nomS = f1.nomS.value ;
            var nomF = f1.nomF.Value ;
            var chef = f1.chef.Value ;
            var prix = f1.prix.Value ;
            var description = f1.description.Value ;
            var dateD = f1.dateD.Value ;
            var dateF = f1.dateF.Value ;

            if(codeF="" || isNaN(codeF))
                return 0 ;
...
<ul class="sidebar-menu">                
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <!-- houni -->
              <form name="f1" method="GET" action="AjouterFormation.php">
<table id="example1" class="table table-striped">
<caption></caption>
<tr>
<td>Code Formation</td>
<td><input type="number" name="codeF"></td>
</tr>
<tr>
<td>Nom Specialite</td>
<td>
<select size="1" name="nomS">
     <?PHP
include "../cores/specialiteC.php";
$specialite1C=new specialiteC();
$listeSpecialites=$specialite1C->AfficherSpecialite() ;
 foreach($listeSpecialites as $row) {
    ?>
                <option><?PHP echo $row['nomS']; ?> </option>
...
<td><input type="file" name="imagef"></td>
</tr>

<tr>
<td></td>
<td><button name="ajouter"  class="btn btn-danger">Envoyée</button></td>
</tr>
</table>
</form>
