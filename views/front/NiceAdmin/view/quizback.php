...
$reclamation1C=new quizC();
$list=$reclamation1C->recupererQuiz();
$moy=0;
$count=0;
$moy1=0;
$count1=0;
...
<ul class="sidebar-menu">                
      ...
      <section id="main-content">
		  ...
		  <div class="row">
            ...
            <div>
            <h3> moy des notes sur les formations : <?php
             echo $moy/$count ; 
             ?> </h3> 
            <h3> moy des notes sur les formateurs : <?php
             echo $moy1/$count1 ;
             ?> </h3>
            </div>
        ...
        <?php
            ...
            <tr>
                ...
                <td><?php echo $row['score'] ?></td>
                                <td><?php if($row['idquiz']==1){?> Quiz sur les formations <?php }else{ ?> Quiz sur les formateurs <?php } ?></td>
            </tr>
            <?php
                    }
            ?>
