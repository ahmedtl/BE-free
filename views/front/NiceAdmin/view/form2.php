...
<ul class="sidebar-menu">                
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> Gestion de specialité</h3>
                                            
                    </ol>
                </div>
            </div>
              <!-- houni -->
<form name="f1" method="GET" action="AjouterSpecialite.php">
<table id="example1" class="table table-striped">
<caption></caption>
<tr>
<td>Code Specialite</td>
<td><input type="number" name="codeS"></td>
</tr>
<tr>
