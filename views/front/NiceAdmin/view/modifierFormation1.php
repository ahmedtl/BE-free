...
<?php
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index." clphpass="logo">La <span class="lite">Dacquoise</span></a>
            <!--logo end-->
...
if (isset($_GET['codeF'])){
    ...
    $result=$formationC->recupererFormation($_GET['codeF']);
...
<caption>Modifier Formation</caption>
<tr>
<td>Code Formation</td>
<td><input type="number" name="codeF" value="<?PHP echo $codeF ?>"></td>
</tr>
<tr>
...
<tr>
<td>Nom Formation</td>
<td><input type="text" name="nomF" value="<?PHP echo $nomF ?>"></td>
</tr>
<tr>
<td>Nom Chef</td>
<td><input type="text" name="chef" value="<?PHP echo $chef ?>"></td>
</tr>
<tr>
<td>Prix</td>
...
<td><input type="file" name="imagef" value="<?PHP echo $imagef ?>"></td>
</tr>
<tr>
<td></td>
<td><input type="submit" name="modifier" value="modifier" action="afficherSpecialite1.php class="btn btn-danger"></td>
</tr>
<tr>
<td></td>
<td><input type="hidden" name="codeFF" value="<?PHP echo $_GET['codeF'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
    $formation=new formation($_POST['codeF'],$_POST['nomS'],$_POST['nomF'],$_POST['chef'],$_POST['prix'],$_POST['description'],$_POST['dateD'],$_POST['dateF'],$_POST['imagef']);
    $formationC->modifierFormation($formation,$_POST['codeFF']);
    echo $_POST['codeFF'];
