                ...
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <div class="panel-body">
                              <div class="form" >
                                  <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="ajoutercheff.php" enctype= multipart/form-data">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cemail" type="text" name="prenom_chef" placeholder="Prenom..."  required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">Image chef  <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cemail" type="text" name="image" placeholder="Image..."  />
                                          </div>
                                      </div>
                                    <<!--<div class="form-group">
