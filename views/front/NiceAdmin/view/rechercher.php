...
{
$listeevent=$eventCore->rechercherevent($_GET['search_key']);
}
else
{
$listeevent=$eventCore->afficher_return(); 
}
?>
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
                                 ...
                                 <th><i class="icon_calendar"></i>titre</th>
                                 <th><i class="icon_mail_alt"></i> description</th>
                                 <th><i class="icon_profile"></i>type</th>
                                  <th><i class="icon_profile"></i>date d'event </th>
    ...
    <tbody> 
    <tr>     
    <td><?php echo $donne['reference'] ?></td>
    <td><?php echo $donne['titre'] ?></td>
    <td><?php echo $donne['description'] ?></td>
    <td><?php echo $donne['type']?></td>
    <td><?php echo $donne['dateevent']?></td>
    <td><img src="imagesevents/<?php echo $donne['photo']?>" style="width:80px;"></td>

    <form method="POST" action="supprimerevent.php">
    <td><input type="submit" class="btn btn-danger" name="supprimer" value="supprimer">
    <input type="hidden" value="<?php echo $donne['reference'];?>" name="ref">
    </td>
    </form>

    <form method="POST" action="modifierevent.php">
    <td><input type="submit" class="btn btn-danger" name="modifier" value="modifier">
    <input type="hidden" name="ref" value="<?php echo $donne['reference'];?>">
    <input type="hidden" name="titre" value="<?php echo $donne['titre'];?>">    
    <input type="hidden" name="description" value="<?php echo $donne['description'];?>"> 
    <input type="hidden" name="type" value="<?php echo $donne['type'];?>"> 
    <input type="hidden" name="dateevent" value="<?php echo $donne['dateevent'];?>"> 
    <input type="hidden" name="photo" value="<?php echo $donne['photo'];?>"> 
    </td>
    </form>
