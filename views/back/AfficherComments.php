            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                                   <a href="AfficherForms.php">
                                <i class="fas fa-bars"></i>List Pubs</a>
                        </li>
...
" class="au-btn au-btn-icon au-btn--blue">
                                         <a id="logout" href="../Logout.php" style="
    color: white;
"> <i class="fa fa-minus"></i> <span class="d-none d-sm-inline">Logout </span></a></button>
                                </div>
